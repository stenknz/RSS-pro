...
import { feedsApi, categoriesApi, authApi } from '../../api/client'
    ...
    <div className="h-full flex flex-col bg-white dark:bg-gray-950 border-r border-gray-200 dark:border-gray-800">
      ...
      <div className="p-3 border-t border-gray-100 dark:border-gray-800 space-y-0.5">
        ...
        <button
          ...
          className="flex items-center gap-3 w-full px-3 py-2 rounded-lg text-sm text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-900 hover:text-red-600 dark:hover:text-red-400 transition-all duration-150"
        >
          {icons.logout}
          <span>Log out</span>
        </button>
